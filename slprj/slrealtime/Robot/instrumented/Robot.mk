...
## 
## Makefile     : Robot.mk
## Generated on : Thu Apr 11 15:40:23 2024
## Final product: ./Robot_rtwlib.a
...
SRCS = $(START_DIR)/slprj/slrealtime/Robot/Robot.cpp $(START_DIR)/slprj/slrealtime/Robot/Robot_cal.cpp $(START_DIR)/slprj/slrealtime/Robot/slrealtime_datatype_ground.cpp $(START_DIR)/ecat_config_xml_0.cpp $(MATLAB_ROOT)/toolbox/slrealtime/simulink/blocks/slrtEcatUtils.cpp
...
OBJS = Robot.o Robot_cal.o slrealtime_datatype_ground.o ecat_config_xml_0.o slrtEcatUtils.o
...
%.o : $(START_DIR)/slprj/slrealtime/Robot/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/slprj/slrealtime/Robot/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
Robot.o : $(START_DIR)/slprj/slrealtime/Robot/Robot.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


Robot_cal.o : $(START_DIR)/slprj/slrealtime/Robot/Robot_cal.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


slrealtime_datatype_ground.o : $(START_DIR)/slprj/slrealtime/Robot/slrealtime_datatype_ground.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
