...
const int32_T Robot_CALL_EVENT = -1;
...
const int32_T Robot_CALL_EVENT_a = -1;
...
ExtU_Robot_T Robot_U;

/* External outputs (root outports fed by signals with default storage) */
ExtY_Robot_T Robot_Y;

/* Real-time model */
RT_MODEL_Robot_T Robot_M_ = RT_MODEL_Robot_T();
RT_MODEL_Robot_T *const Robot_M = &Robot_M_;
const ControlBus Robot_rtZControlBus = { 0.0,/* Motor1Torque */
  0.0                                  /* Motor2Torque */
};

const SensingBus Robot_rtZSensingBus = { 0.0,/* Motor1ActuralPosition */
  0.0,                                 /* Motor1ActuralVelocity */
  0.0,                                 /* Motor1ActuralTorque */
  0.0,                                 /* Motor1DCLinkCircuitVoltage */
  0.0,                                 /* Motor2ActuralPosition */
  0.0,                                 /* Motor2ActuralVelocity */
  0.0,                                 /* Motor2ActuralTorque */
  0.0,                                 /* Motor2DCLinkCircuitVoltage */
  0.0,                                 /* Sensor1ADCh1 */
  0.0,                                 /* Sensor1ADCh2 */
  0.0,                                 /* Sensor1IMUq0 */
  0.0,                                 /* Sensor1IMUq1 */
...
{
  localDW->sfEvent = Robot_CALL_EVENT;
...
void Robot_step(void)
{
...

  {
    ...
    srClearBC(Robot_DW.IfActionSubsystem7.IfActionSubsystem7_SubsysRanBC);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.IfActionSubsystem5.IfActionSubsystem5_SubsysRanBC);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.GetMasterStateOPFrame_SubsysRanBC_g);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.IfActionSubsystem.IfActionSubsystem_SubsysRanBC);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.PDOSet0x60406715Frame_SubsysRanBC_b1);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.SDOGet0x6075Frame_SubsysRanBC_l);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.SDOSet0x606010Frame_SubsysRanBC_o);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.SDOSet0x60801Frame_SubsysRanBC_e);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.SetMasterStatetoOPFrame_SubsysRanBC_l);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.SetMasterStatetoSafeOPFrame_SubsysRanBC_c);

    /* Reset subsysRan breadcrumbs */
    srClearBC
      (Robot_DW.SwitchCaseActionSubsystem1_f4.SwitchCaseActionSubsystem1_SubsysRanBC);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.Motor1TorqueControlInitFrame_SubsysRanBC);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.GetMasterStateOPFrame_SubsysRanBC_p);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.PDOSet0x60406715Frame_SubsysRanBC_p);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.SDOGet0x6075Frame_SubsysRanBC_g);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.SDOSet0x606010Frame_SubsysRanBC_p);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.SDOSet0x60801Frame_SubsysRanBC_a);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.SetMasterStatetoOPFrame_SubsysRanBC_j);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.SetMasterStatetoSafeOPFrame_SubsysRanBC_g);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.Motor2TorqueControlInitFrame_SubsysRanBC);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.GetMasterStateOPFrame_SubsysRanBC_l);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.PDOSet0x60406715Frame_SubsysRanBC_b);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.SDOGet0x6075Frame_SubsysRanBC_m);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.SDOSet0x606010Frame_SubsysRanBC_m);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.SDOSet0x60801Frame_SubsysRanBC_l);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.SetMasterStatetoOPFrame_SubsysRanBC_k);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.SetMasterStatetoSafeOPFrame_SubsysRanBC_j);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.Motor3TorqueControlInitFrame_SubsysRanBC);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.GetMasterStateOPFrame_SubsysRanBC);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.PDOSet0x60406715Frame_SubsysRanBC);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.SDOGet0x6075Frame_SubsysRanBC);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.SDOSet0x606010Frame_SubsysRanBC);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.SDOSet0x60801Frame_SubsysRanBC);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.SetMasterStatetoOPFrame_SubsysRanBC);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.SetMasterStatetoSafeOPFrame_SubsysRanBC);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.Motor4TorqueControlInitFrame_SubsysRanBC);

    /* Reset subsysRan breadcrumbs */
    srClearBC(Robot_DW.Robot_SubsysRanBC);
    ...
    Robot_B.Constant2 = Robot_cal->State_1_Enable_TaskIndex_njg;

    /* Memory: '<Root>/Memory1' */
    Robot_B.Memory1 = Robot_DW.Memory1_PreviousInput;

    /* Chart: '<Root>/Chart' */
    Robot_DW.sfEvent = Robot_CALL_EVENT_a;
     ...
     */
    tmp_1 = static_cast<int32_T>(Robot_B.State);
    if (tmp_1 == 1) {
    ...
    if (Robot_B.Merge > 0.0) {
      ...
      /* Chart: '<S2>/Chart' */
      Robot_Chart(Robot_B.Constant2, Robot_B.Memory1_o, &Robot_B.sf_Chart_g,
                  &Robot_DW.sf_Chart_g);
      ...
      if (Robot_B.Merge_nf > 0.0) {
        Robot_DW.SetMasterStatetoSafeOPFrame_MODE_l = true;
        ...
        if (Robot_B.SetDeviceState_o1_l == 4) {
          ...
          srUpdateBC
            (Robot_DW.IfActionSubsystem7_i.IfActionSubsystem7_SubsysRanBC);
        ...
        /* Clock: '<S19>/Clock' */
        Robot_B.Clock_nm = Robot_M->Timing.t[0];
        srUpdateBC(Robot_DW.SetMasterStatetoSafeOPFrame_SubsysRanBC_c);
      } else if (Robot_DW.SetMasterStatetoSafeOPFrame_MODE_l) {
        /* Disable for If: '<S19>/If1' */
        Robot_DW.If1_ActiveSubsystem_ke = -1;
        Robot_DW.SetMasterStatetoSafeOPFrame_MODE_l = false;
      }
      ...
      if ((u < 0.0 ? -static_cast<int32_T>(static_cast<uint32_T>(-u)) :
         ...
         */
        Robot_IfActionSubsystem5(Robot_cal->Constant_Value_l, &Robot_B.Merge_gf);
      ...
      if (Robot_B.Merge_gf > 0.0) {
        Robot_DW.SDOGet0x6075Frame_MODE_ie = true;
        ...
        /* Clock: '<S15>/Clock' */
        Robot_B.Clock_nj = Robot_M->Timing.t[0];

        /* If: '<S15>/If1' */
        Robot_DW.If1_ActiveSubsystem_lk = 1;
        srUpdateBC(Robot_DW.SDOGet0x6075Frame_SubsysRanBC_l);
      } else if (Robot_DW.SDOGet0x6075Frame_MODE_ie) {
        /* Disable for If: '<S15>/If1' */
        Robot_DW.If1_ActiveSubsystem_lk = -1;
        Robot_DW.SDOGet0x6075Frame_MODE_ie = false;
      }
      ...
      if ((u < 0.0 ? -static_cast<int32_T>(static_cast<uint32_T>(-u)) :
         ...
         */
        Robot_IfActionSubsystem5(Robot_cal->Constant_Value_lp, &Robot_B.Merge_dt);
      ...
      if (Robot_B.Merge_dt > 0.0) {
        ...
        /* Clock: '<S17>/Clock' */
        Robot_B.Clock_m3 = Robot_M->Timing.t[0];

        /* If: '<S17>/If1' */
        Robot_DW.If1_ActiveSubsystem_hv = 1;
        srUpdateBC(Robot_DW.SDOSet0x60801Frame_SubsysRanBC_e);
      ...
      if ((u < 0.0 ? -static_cast<int32_T>(static_cast<uint32_T>(-u)) :
         ...
         */
        Robot_IfActionSubsystem5(Robot_cal->Constant_Value_p, &Robot_B.Merge_au);
      ...
      if (Robot_B.Merge_au > 0.0) {
        Robot_DW.SDOSet0x606010Frame_MODE_pk = true;
        ...
        /* Clock: '<S16>/Clock' */
        Robot_B.Clock_mk = Robot_M->Timing.t[0];

        /* If: '<S16>/If1' */
        Robot_DW.If1_ActiveSubsystem_pj = 1;
        srUpdateBC(Robot_DW.SDOSet0x606010Frame_SubsysRanBC_o);
      } else if (Robot_DW.SDOSet0x606010Frame_MODE_pk) {
        /* Disable for If: '<S16>/If1' */
        Robot_DW.If1_ActiveSubsystem_pj = -1;
        Robot_DW.SDOSet0x606010Frame_MODE_pk = false;
      }
      ...
      if ((u < 0.0 ? -static_cast<int32_T>(static_cast<uint32_T>(-u)) :
         ...
         */
        Robot_IfActionSubsystem5(Robot_cal->Constant_Value_i, &Robot_B.Merge_g1);
      ...
      if (Robot_B.Merge_g1 > 0.0) {
        Robot_DW.SetMasterStatetoOPFrame_MODE_hr = true;
        ...
        if (Robot_B.SetDeviceState_o1_a == 8) {
          ...
          srUpdateBC
            (Robot_DW.IfActionSubsystem7_pl.IfActionSubsystem7_SubsysRanBC);
        ...
        /* Clock: '<S18>/Clock' */
        Robot_B.Clock_c = Robot_M->Timing.t[0];
        srUpdateBC(Robot_DW.SetMasterStatetoOPFrame_SubsysRanBC_l);
      } else if (Robot_DW.SetMasterStatetoOPFrame_MODE_hr) {
        /* Disable for If: '<S18>/If1' */
        Robot_DW.If1_ActiveSubsystem_p4 = -1;
        Robot_DW.SetMasterStatetoOPFrame_MODE_hr = false;
      }
      ...
      if (Robot_B.Merge_l > 0.0) {
        Robot_DW.GetMasterStateOPFrame_MODE_b = true;
        ...
        /* Clock: '<S13>/Clock' */
        Robot_B.Clock_i = Robot_M->Timing.t[0];

        /* If: '<S13>/If1' */
        Robot_DW.If1_ActiveSubsystem_j = 1;
        srUpdateBC(Robot_DW.GetMasterStateOPFrame_SubsysRanBC_g);
      } else if (Robot_DW.GetMasterStateOPFrame_MODE_b) {
        /* Disable for If: '<S13>/If1' */
        Robot_DW.If1_ActiveSubsystem_j = -1;
        Robot_DW.GetMasterStateOPFrame_MODE_b = false;
      }
      ...
      if ((u < 0.0 ? -static_cast<int32_T>(static_cast<uint32_T>(-u)) :
         ...
         */
        Robot_IfActionSubsystem5(Robot_cal->Constant_Value_a, &Robot_B.Merge_oj);
      ...
      if (Robot_B.Merge_oj > 0.0) {
        ...
        if ((Robot_B.EtherCATPDOReceive1_g == 4663) ||
          ...
          srUpdateBC
            (Robot_DW.IfActionSubsystem7_p.IfActionSubsystem7_SubsysRanBC);
        ...
        /* Clock: '<S14>/Clock' */
        Robot_B.Clock_ea = Robot_M->Timing.t[0];
        srUpdateBC(Robot_DW.PDOSet0x60406715Frame_SubsysRanBC_b1);
      ...
      if (Robot_DW.SDOGet0x6075Frame_MODE_ie) {
        /* Disable for If: '<S15>/If1' */
        Robot_DW.If1_ActiveSubsystem_lk = -1;
        Robot_DW.SDOGet0x6075Frame_MODE_ie = false;
      }
      ...
      if (Robot_DW.SDOSet0x606010Frame_MODE_pk) {
        /* Disable for If: '<S16>/If1' */
        Robot_DW.If1_ActiveSubsystem_pj = -1;
        Robot_DW.SDOSet0x606010Frame_MODE_pk = false;
      }
      ...
      if (Robot_DW.SetMasterStatetoOPFrame_MODE_hr) {
        /* Disable for If: '<S18>/If1' */
        Robot_DW.If1_ActiveSubsystem_p4 = -1;
        Robot_DW.SetMasterStatetoOPFrame_MODE_hr = false;
      }
      ...
      if (Robot_DW.GetMasterStateOPFrame_MODE_b) {
        /* Disable for If: '<S13>/If1' */
        Robot_DW.If1_ActiveSubsystem_j = -1;
        Robot_DW.GetMasterStateOPFrame_MODE_b = false;
      }
    ...
    /* DataTypeConversion: '<S295>/Data Type Conversion1' */
    Robot_B.DataTypeConversion1 = static_cast<int16_T>(u < 0.0 ?
    ...
    Robot_B.Constant2_a = Robot_cal->State_2_Enable_TaskIndex_g;
    ...
    if (Robot_B.Merge_i > 0.0) {
      ...
      /* Chart: '<S3>/Chart' */
      Robot_Chart(Robot_B.Constant2_a, Robot_B.Memory1_k, &Robot_B.sf_Chart_o,
                  &Robot_DW.sf_Chart_o);
      ...
      if (Robot_B.Merge_h > 0.0) {
        ...
        /* Clock: '<S77>/Clock' */
        Robot_B.Clock_a = Robot_M->Timing.t[0];

        /* If: '<S77>/If1' */
        Robot_DW.If1_ActiveSubsystem_e = 1;
        srUpdateBC(Robot_DW.GetMasterStateOPFrame_SubsysRanBC_p);
      ...
      if ((u < 0.0 ? -static_cast<int32_T>(static_cast<uint32_T>(-u)) :
         ...
         */
        Robot_IfActionSubsystem5(Robot_cal->Constant_Value_g, &Robot_B.Merge_o4);
      ...
      if (Robot_B.Merge_o4 > 0.0) {
        Robot_DW.SetMasterStatetoSafeOPFrame_MODE_e = true;
        ...
        if (Robot_B.SetDeviceState_o1_m == 4) {
          ...
          srUpdateBC
            (Robot_DW.IfActionSubsystem7_p5.IfActionSubsystem7_SubsysRanBC);
        ...
        /* Clock: '<S83>/Clock' */
        Robot_B.Clock_gk = Robot_M->Timing.t[0];
        srUpdateBC(Robot_DW.SetMasterStatetoSafeOPFrame_SubsysRanBC_g);
      } else if (Robot_DW.SetMasterStatetoSafeOPFrame_MODE_e) {
        /* Disable for If: '<S83>/If1' */
        Robot_DW.If1_ActiveSubsystem_a = -1;
        Robot_DW.SetMasterStatetoSafeOPFrame_MODE_e = false;
      }
      ...
      if ((u < 0.0 ? -static_cast<int32_T>(static_cast<uint32_T>(-u)) :
         ...
         */
        Robot_IfActionSubsystem5(Robot_cal->Constant_Value_fc, &Robot_B.Merge_ex);
      ...
      if (Robot_B.Merge_ex > 0.0) {
        Robot_DW.SDOGet0x6075Frame_MODE_e = true;
        ...
        /* Clock: '<S79>/Clock' */
        Robot_B.Clock_ke = Robot_M->Timing.t[0];

        /* If: '<S79>/If1' */
        Robot_DW.If1_ActiveSubsystem_ma = 1;
        srUpdateBC(Robot_DW.SDOGet0x6075Frame_SubsysRanBC_g);
      } else if (Robot_DW.SDOGet0x6075Frame_MODE_e) {
        /* Disable for If: '<S79>/If1' */
        Robot_DW.If1_ActiveSubsystem_ma = -1;
        Robot_DW.SDOGet0x6075Frame_MODE_e = false;
      }
      ...
      if (Robot_B.Merge_k > 0.0) {
        Robot_DW.SDOSet0x60801Frame_MODE_h = true;
        ...
        /* Clock: '<S81>/Clock' */
        Robot_B.Clock_h = Robot_M->Timing.t[0];

        /* If: '<S81>/If1' */
        Robot_DW.If1_ActiveSubsystem_d = 1;
        srUpdateBC(Robot_DW.SDOSet0x60801Frame_SubsysRanBC_a);
      } else if (Robot_DW.SDOSet0x60801Frame_MODE_h) {
        /* Disable for If: '<S81>/If1' */
        Robot_DW.If1_ActiveSubsystem_d = -1;
        Robot_DW.SDOSet0x60801Frame_MODE_h = false;
      }
      ...
      if ((u < 0.0 ? -static_cast<int32_T>(static_cast<uint32_T>(-u)) :
         ...
         */
        Robot_IfActionSubsystem5(Robot_cal->Constant_Value_fj, &Robot_B.Merge_jq);
      ...
      if (Robot_B.Merge_jq > 0.0) {
        Robot_DW.SDOSet0x606010Frame_MODE_k = true;
        ...
        /* Clock: '<S80>/Clock' */
        Robot_B.Clock_nw = Robot_M->Timing.t[0];

        /* If: '<S80>/If1' */
        Robot_DW.If1_ActiveSubsystem_iq = 1;
        srUpdateBC(Robot_DW.SDOSet0x606010Frame_SubsysRanBC_p);
      } else if (Robot_DW.SDOSet0x606010Frame_MODE_k) {
        /* Disable for If: '<S80>/If1' */
        Robot_DW.If1_ActiveSubsystem_iq = -1;
        Robot_DW.SDOSet0x606010Frame_MODE_k = false;
      }
      ...
      if ((u < 0.0 ? -static_cast<int32_T>(static_cast<uint32_T>(-u)) :
         ...
         */
        Robot_IfActionSubsystem5(Robot_cal->Constant_Value_l0, &Robot_B.Merge_op);
      ...
      if (Robot_B.Merge_op > 0.0) {
        Robot_DW.SetMasterStatetoOPFrame_MODE_c = true;
        ...
        if (Robot_B.SetDeviceState_o1_k == 8) {
          ...
          srUpdateBC
            (Robot_DW.IfActionSubsystem7_m.IfActionSubsystem7_SubsysRanBC);
        ...
        /* Clock: '<S82>/Clock' */
        Robot_B.Clock_gy = Robot_M->Timing.t[0];
        srUpdateBC(Robot_DW.SetMasterStatetoOPFrame_SubsysRanBC_j);
      } else if (Robot_DW.SetMasterStatetoOPFrame_MODE_c) {
        /* Disable for If: '<S82>/If1' */
        Robot_DW.If1_ActiveSubsystem_i = -1;
        Robot_DW.SetMasterStatetoOPFrame_MODE_c = false;
      }
      ...
      if ((u < 0.0 ? -static_cast<int32_T>(static_cast<uint32_T>(-u)) :
         ...
         */
        Robot_IfActionSubsystem5(Robot_cal->Constant_Value_nn, &Robot_B.Merge_by);
      ...
      if (Robot_B.Merge_by > 0.0) {
        Robot_DW.PDOSet0x60406715Frame_MODE_e = true;
         ...
         */
        if ((Robot_B.EtherCATPDOReceive1_lv == 720) && (Robot_B.Output_f == 500))
        {
        ...
        } else if ((Robot_B.EtherCATPDOReceive1_lv == 689) && (Robot_B.Output_f ==
                    500)) {
        ...
        } else if ((Robot_B.EtherCATPDOReceive1_lv == 691) && (Robot_B.Output_f ==
                    500)) {
        ...
        if ((Robot_B.EtherCATPDOReceive1_lv == 4663) ||
          ...
          srUpdateBC
            (Robot_DW.IfActionSubsystem7_hj.IfActionSubsystem7_SubsysRanBC);
        ...
        /* Clock: '<S78>/Clock' */
        Robot_B.Clock_fl = Robot_M->Timing.t[0];
        srUpdateBC(Robot_DW.PDOSet0x60406715Frame_SubsysRanBC_p);
      } else if (Robot_DW.PDOSet0x60406715Frame_MODE_e) {
        /* Disable for If: '<S78>/If1' */
        Robot_DW.If1_ActiveSubsystem_gn = -1;
        Robot_DW.PDOSet0x60406715Frame_MODE_e = false;
      }
      ...
      if ((u < 0.0 ? -static_cast<int32_T>(static_cast<uint32_T>(-u)) :
         ...
         */
        Robot_IfActionSubsystem5(Robot_cal->Constant_Value_d, &Robot_B.Merge_mo);
      ...
      Robot_B.Constant2_e5 = Robot_cal->State_9_Enable_TaskIndex;
      srUpdateBC(Robot_DW.Motor2TorqueControlInitFrame_SubsysRanBC);
      ...
      if (Robot_DW.SetMasterStatetoSafeOPFrame_MODE_e) {
        /* Disable for If: '<S83>/If1' */
        Robot_DW.If1_ActiveSubsystem_a = -1;
        Robot_DW.SetMasterStatetoSafeOPFrame_MODE_e = false;
      }
      ...
      if (Robot_DW.SDOGet0x6075Frame_MODE_e) {
        /* Disable for If: '<S79>/If1' */
        Robot_DW.If1_ActiveSubsystem_ma = -1;
        Robot_DW.SDOGet0x6075Frame_MODE_e = false;
      }
      ...
      if (Robot_DW.SDOSet0x60801Frame_MODE_h) {
        /* Disable for If: '<S81>/If1' */
        Robot_DW.If1_ActiveSubsystem_d = -1;
        Robot_DW.SDOSet0x60801Frame_MODE_h = false;
      }
      ...
      if (Robot_DW.SDOSet0x606010Frame_MODE_k) {
        /* Disable for If: '<S80>/If1' */
        Robot_DW.If1_ActiveSubsystem_iq = -1;
        Robot_DW.SDOSet0x606010Frame_MODE_k = false;
      }
      ...
      if (Robot_DW.SetMasterStatetoOPFrame_MODE_c) {
        /* Disable for If: '<S82>/If1' */
        Robot_DW.If1_ActiveSubsystem_i = -1;
        Robot_DW.SetMasterStatetoOPFrame_MODE_c = false;
      }
      ...
      if (Robot_DW.PDOSet0x60406715Frame_MODE_e) {
        /* Disable for If: '<S78>/If1' */
        Robot_DW.If1_ActiveSubsystem_gn = -1;
        Robot_DW.PDOSet0x60406715Frame_MODE_e = false;
      }
    ...
    /* DataTypeConversion: '<S297>/Data Type Conversion1' */
    Robot_B.DataTypeConversion1_m = static_cast<int16_T>(u < 0.0 ? static_cast<
     ...
     *  Inport: '<Root>/BusIn'
     */
    Robot_B.Gain1_e = Robot_cal->Gain1_Gain_n * Robot_U.BusIn.Motor1Torque;

    /* Constant: '<S286>/Constant2' */
    Robot_B.Constant2_f = Robot_cal->State_3_Enable_TaskIndex_a;
    ...
    if (Robot_B.Merge_a > 0.0) {
      ...
      /* Chart: '<S4>/Chart' */
      Robot_Chart(Robot_B.Constant2_f, Robot_B.Memory1_a, &Robot_B.sf_Chart_a,
                  &Robot_DW.sf_Chart_a);
      ...
      if ((u < 0.0 ? -static_cast<int32_T>(static_cast<uint32_T>(-u)) :
         ...
         */
        Robot_IfActionSubsystem5(Robot_cal->Constant_Value_gr, &Robot_B.Merge_eb);
      ...
      if (Robot_B.Merge_eb > 0.0) {
        ...
        /* Clock: '<S145>/Clock' */
        Robot_B.Clock_e = Robot_M->Timing.t[0];

        /* If: '<S145>/If1' */
        Robot_DW.If1_ActiveSubsystem_mo = 1;
        srUpdateBC(Robot_DW.GetMasterStateOPFrame_SubsysRanBC_l);
      ...
      if (Robot_B.Merge_o > 0.0) {
        Robot_DW.SetMasterStatetoSafeOPFrame_MODE_a = true;
        ...
        if (Robot_B.SetDeviceState_o1_f == 4) {
          ...
          srUpdateBC
            (Robot_DW.IfActionSubsystem7_n.IfActionSubsystem7_SubsysRanBC);
        ...
        /* Clock: '<S151>/Clock' */
        Robot_B.Clock_n = Robot_M->Timing.t[0];
        srUpdateBC(Robot_DW.SetMasterStatetoSafeOPFrame_SubsysRanBC_j);
      } else if (Robot_DW.SetMasterStatetoSafeOPFrame_MODE_a) {
        /* Disable for If: '<S151>/If1' */
        Robot_DW.If1_ActiveSubsystem_l2 = -1;
        Robot_DW.SetMasterStatetoSafeOPFrame_MODE_a = false;
      }
      ...
      if ((u < 0.0 ? -static_cast<int32_T>(static_cast<uint32_T>(-u)) :
         ...
         */
        Robot_IfActionSubsystem5(Robot_cal->Constant_Value_o, &Robot_B.Merge_ev);
      ...
      if (Robot_B.Merge_ev > 0.0) {
        Robot_DW.SDOGet0x6075Frame_MODE_i = true;
        ...
        /* Clock: '<S147>/Clock' */
        Robot_B.Clock_oe = Robot_M->Timing.t[0];

        /* If: '<S147>/If1' */
        Robot_DW.If1_ActiveSubsystem_c = 1;
        srUpdateBC(Robot_DW.SDOGet0x6075Frame_SubsysRanBC_m);
      } else if (Robot_DW.SDOGet0x6075Frame_MODE_i) {
        /* Disable for If: '<S147>/If1' */
        Robot_DW.If1_ActiveSubsystem_c = -1;
        Robot_DW.SDOGet0x6075Frame_MODE_i = false;
      }
      ...
      if ((u < 0.0 ? -static_cast<int32_T>(static_cast<uint32_T>(-u)) :
         ...
         */
        Robot_IfActionSubsystem5(Robot_cal->Constant_Value_n3, &Robot_B.Merge_p);
      ...
      if (Robot_B.Merge_p > 0.0) {
        ...
        /* Clock: '<S149>/Clock' */
        Robot_B.Clock_bp = Robot_M->Timing.t[0];

        /* If: '<S149>/If1' */
        Robot_DW.If1_ActiveSubsystem_k = 1;
        srUpdateBC(Robot_DW.SDOSet0x60801Frame_SubsysRanBC_l);
      ...
      if ((u < 0.0 ? -static_cast<int32_T>(static_cast<uint32_T>(-u)) :
         ...
         */
        Robot_IfActionSubsystem5(Robot_cal->Constant_Value_b, &Robot_B.Merge_di);
      ...
      if (Robot_B.Merge_di > 0.0) {
        Robot_DW.SDOSet0x606010Frame_MODE_p = true;
        ...
        /* Clock: '<S148>/Clock' */
        Robot_B.Clock_m = Robot_M->Timing.t[0];

        /* If: '<S148>/If1' */
        Robot_DW.If1_ActiveSubsystem_h = 1;
        srUpdateBC(Robot_DW.SDOSet0x606010Frame_SubsysRanBC_m);
      } else if (Robot_DW.SDOSet0x606010Frame_MODE_p) {
        /* Disable for If: '<S148>/If1' */
        Robot_DW.If1_ActiveSubsystem_h = -1;
        Robot_DW.SDOSet0x606010Frame_MODE_p = false;
      }
      ...
      if ((u < 0.0 ? -static_cast<int32_T>(static_cast<uint32_T>(-u)) :
         ...
         */
        Robot_IfActionSubsystem5(Robot_cal->Constant_Value_n0, &Robot_B.Merge_ne);
      ...
      if (Robot_B.Merge_ne > 0.0) {
        Robot_DW.SetMasterStatetoOPFrame_MODE_h = true;
        ...
        if (Robot_B.SetDeviceState_o1_h == 8) {
          ...
          srUpdateBC
            (Robot_DW.IfActionSubsystem7_ld.IfActionSubsystem7_SubsysRanBC);
        ...
        /* Clock: '<S150>/Clock' */
        Robot_B.Clock_g = Robot_M->Timing.t[0];
        srUpdateBC(Robot_DW.SetMasterStatetoOPFrame_SubsysRanBC_k);
      } else if (Robot_DW.SetMasterStatetoOPFrame_MODE_h) {
        /* Disable for If: '<S150>/If1' */
        Robot_DW.If1_ActiveSubsystem_g = -1;
        Robot_DW.SetMasterStatetoOPFrame_MODE_h = false;
      }
      ...
      if ((u < 0.0 ? -static_cast<int32_T>(static_cast<uint32_T>(-u)) :
         ...
         */
        Robot_IfActionSubsystem5(Robot_cal->Constant_Value_o0, &Robot_B.Merge_g5);
      ...
      if (Robot_B.Merge_g5 > 0.0) {
        Robot_DW.PDOSet0x60406715Frame_MODE_a = true;
         ...
         */
        if ((Robot_B.EtherCATPDOReceive1_dh == 720) && (Robot_B.Output_j == 500))
        {
        ...
        } else if ((Robot_B.EtherCATPDOReceive1_dh == 689) && (Robot_B.Output_j ==
                    500)) {
        ...
        } else if ((Robot_B.EtherCATPDOReceive1_dh == 691) && (Robot_B.Output_j ==
                    500)) {
        ...
        if ((Robot_B.EtherCATPDOReceive1_dh == 4663) ||
          ...
          srUpdateBC
            (Robot_DW.IfActionSubsystem7_d.IfActionSubsystem7_SubsysRanBC);
        ...
        /* Clock: '<S146>/Clock' */
        Robot_B.Clock_j = Robot_M->Timing.t[0];
        srUpdateBC(Robot_DW.PDOSet0x60406715Frame_SubsysRanBC_b);
      } else if (Robot_DW.PDOSet0x60406715Frame_MODE_a) {
        /* Disable for If: '<S146>/If1' */
        Robot_DW.If1_ActiveSubsystem_mz = -1;
        Robot_DW.PDOSet0x60406715Frame_MODE_a = false;
      }
      ...
      if ((u < 0.0 ? -static_cast<int32_T>(static_cast<uint32_T>(-u)) :
         ...
         */
        Robot_IfActionSubsystem5(Robot_cal->Constant_Value_dx, &Robot_B.Merge_b);
      ...
      Robot_B.Constant2_iq = Robot_cal->State_9_Enable_TaskIndex_c;
      srUpdateBC(Robot_DW.Motor3TorqueControlInitFrame_SubsysRanBC);
      ...
      if (Robot_DW.SetMasterStatetoSafeOPFrame_MODE_a) {
        /* Disable for If: '<S151>/If1' */
        Robot_DW.If1_ActiveSubsystem_l2 = -1;
        Robot_DW.SetMasterStatetoSafeOPFrame_MODE_a = false;
      }
      ...
      if (Robot_DW.SDOGet0x6075Frame_MODE_i) {
        /* Disable for If: '<S147>/If1' */
        Robot_DW.If1_ActiveSubsystem_c = -1;
        Robot_DW.SDOGet0x6075Frame_MODE_i = false;
      }
      ...
      if (Robot_DW.SDOSet0x606010Frame_MODE_p) {
        /* Disable for If: '<S148>/If1' */
        Robot_DW.If1_ActiveSubsystem_h = -1;
        Robot_DW.SDOSet0x606010Frame_MODE_p = false;
      }
      ...
      if (Robot_DW.SetMasterStatetoOPFrame_MODE_h) {
        /* Disable for If: '<S150>/If1' */
        Robot_DW.If1_ActiveSubsystem_g = -1;
        Robot_DW.SetMasterStatetoOPFrame_MODE_h = false;
      }
      ...
      if (Robot_DW.PDOSet0x60406715Frame_MODE_a) {
        /* Disable for If: '<S146>/If1' */
        Robot_DW.If1_ActiveSubsystem_mz = -1;
        Robot_DW.PDOSet0x60406715Frame_MODE_a = false;
      }
    ...
    /* DataTypeConversion: '<S300>/Data Type Conversion1' */
    Robot_B.DataTypeConversion1_j = static_cast<int16_T>(u < 0.0 ? static_cast<
      int32_T>(static_cast<int16_T>(-static_cast<int16_T>(static_cast<uint16_T>(
      -u)))) : static_cast<int32_T>(static_cast<int16_T>(static_cast<uint16_T>(u))));
     ...
     *  Inport: '<Root>/BusIn'
     */
    Robot_B.Gain1_g = Robot_cal->Gain1_Gain_j * Robot_U.BusIn.Motor2Torque;

    /* Constant: '<S289>/Constant2' */
    Robot_B.Constant2_i = Robot_cal->State_4_Enable_TaskIndex;
    ...
    if (Robot_B.Merge_e > 0.0) {
      ...
      /* Chart: '<S5>/Chart' */
      Robot_Chart(Robot_B.Constant2_i, Robot_B.Memory1_j, &Robot_B.sf_Chart_i,
                  &Robot_DW.sf_Chart_i);
      ...
      if ((u < 0.0 ? -static_cast<int32_T>(static_cast<uint32_T>(-u)) :
         ...
         */
        Robot_IfActionSubsystem5(Robot_cal->Constant_Value_lg, &Robot_B.Merge_iu);
      ...
      if (Robot_B.Merge_iu > 0.0) {
        ...
        /* Clock: '<S213>/Clock' */
        Robot_B.Clock_kz = Robot_M->Timing.t[0];

        /* If: '<S213>/If1' */
        Robot_DW.If1_ActiveSubsystem_p = 1;
        srUpdateBC(Robot_DW.GetMasterStateOPFrame_SubsysRanBC);
      ...
      if ((u < 0.0 ? -static_cast<int32_T>(static_cast<uint32_T>(-u)) :
         ...
         */
        Robot_IfActionSubsystem5(Robot_cal->Constant_Value_ii, &Robot_B.Merge_g);
      ...
      if (Robot_B.Merge_g > 0.0) {
        ...
        if (Robot_B.SetDeviceState_o1 == 4) {
          ...
          srUpdateBC
            (Robot_DW.IfActionSubsystem7_g.IfActionSubsystem7_SubsysRanBC);
        ...
        /* Clock: '<S219>/Clock' */
        Robot_B.Clock = Robot_M->Timing.t[0];
        srUpdateBC(Robot_DW.SetMasterStatetoSafeOPFrame_SubsysRanBC);
      ...
      if ((u < 0.0 ? -static_cast<int32_T>(static_cast<uint32_T>(-u)) :
         ...
         */
        Robot_IfActionSubsystem5(Robot_cal->Constant_Value_fq, &Robot_B.Merge_d);
      ...
      if (Robot_B.Merge_d > 0.0) {
        ...
        /* Clock: '<S215>/Clock' */
        Robot_B.Clock_d = Robot_M->Timing.t[0];

        /* If: '<S215>/If1' */
        Robot_DW.If1_ActiveSubsystem_l = 1;
        srUpdateBC(Robot_DW.SDOGet0x6075Frame_SubsysRanBC);
      ...
      if ((u < 0.0 ? -static_cast<int32_T>(static_cast<uint32_T>(-u)) :
         ...
         */
        Robot_IfActionSubsystem5(Robot_cal->Constant_Value_dm, &Robot_B.Merge_g2);
      ...
      if (Robot_B.Merge_g2 > 0.0) {
        ...
        /* Clock: '<S217>/Clock' */
        Robot_B.Clock_f = Robot_M->Timing.t[0];

        /* If: '<S217>/If1' */
        Robot_DW.If1_ActiveSubsystem_f = 1;
        srUpdateBC(Robot_DW.SDOSet0x60801Frame_SubsysRanBC);
      ...
      if ((u < 0.0 ? -static_cast<int32_T>(static_cast<uint32_T>(-u)) :
         ...
         */
        Robot_IfActionSubsystem5(Robot_cal->Constant_Value_hw, &Robot_B.Merge_f);
      ...
      if (Robot_B.Merge_f > 0.0) {
        ...
        /* Clock: '<S216>/Clock' */
        Robot_B.Clock_b = Robot_M->Timing.t[0];

        /* If: '<S216>/If1' */
        Robot_DW.If1_ActiveSubsystem_b = 1;
        srUpdateBC(Robot_DW.SDOSet0x606010Frame_SubsysRanBC);
      ...
      if ((u < 0.0 ? -static_cast<int32_T>(static_cast<uint32_T>(-u)) :
         ...
         */
        Robot_IfActionSubsystem5(Robot_cal->Constant_Value_dr, &Robot_B.Merge_n);
      ...
      if (Robot_B.Merge_n > 0.0) {
        ...
        if (Robot_B.SetDeviceState_o1_n == 8) {
          ...
          srUpdateBC
            (Robot_DW.IfActionSubsystem7_kq.IfActionSubsystem7_SubsysRanBC);
        ...
        /* Clock: '<S218>/Clock' */
        Robot_B.Clock_o = Robot_M->Timing.t[0];
        srUpdateBC(Robot_DW.SetMasterStatetoOPFrame_SubsysRanBC);
      ...
      if (Robot_B.Merge_j > 0.0) {
        ...
        if ((Robot_B.EtherCATPDOReceive1_hy == 4663) ||
          ...
          srUpdateBC
            (Robot_DW.IfActionSubsystem7_pb.IfActionSubsystem7_SubsysRanBC);
        ...
        /* Clock: '<S214>/Clock' */
        Robot_B.Clock_k = Robot_M->Timing.t[0];
        srUpdateBC(Robot_DW.PDOSet0x60406715Frame_SubsysRanBC);
      ...
      if ((u < 0.0 ? -static_cast<int32_T>(static_cast<uint32_T>(-u)) :
         ...
         */
        Robot_IfActionSubsystem5(Robot_cal->Constant_Value_m3, &Robot_B.Merge_m);
      ...
      srUpdateBC(Robot_DW.Motor4TorqueControlInitFrame_SubsysRanBC);
    ...
    /* DataTypeConversion: '<S296>/Data Type Conversion1' */
    Robot_B.DataTypeConversion1_o = static_cast<int16_T>(u < 0.0 ? static_cast<
      int32_T>(static_cast<int16_T>(-static_cast<int16_T>(static_cast<uint16_T>(
      -u)))) : static_cast<int32_T>(static_cast<int16_T>(static_cast<uint16_T>(u))));
    ...
    if (Robot_B.Merge_eh > 0.0) {
      ...
      /* S-Function (slecatpdorx): '<S310>/EtherCAT PDO Receive5' */
      {
        ...
        for (sigIdx=0; sigIdx < 1; sigIdx++) {
          switch ( 2 ) {
           ...
           case SS_BOOLEAN:
            slrtEcatCopyBitsRx(ecatRxBufPtr, bitOffset, 8, sigOutputPtr+sigIdx*1,
                               1);
            break;
      ...
      srUpdateBC(Robot_DW.Robot_SubsysRanBC);
    }
    ...
    /* Gain: '<S301>/Gain4' */
    Robot_B.Gain4 = static_cast<int64_T>(Robot_cal->Gain4_Gain) * Robot_B.Bias2;

    /* DataTypeConversion: '<S301>/Data Type Conversion6' incorporates:
     *  Gain: '<S301>/Gain4'
     */
    Robot_B.DataTypeConversion6 = static_cast<real_T>(Robot_B.Gain4) *
     ...
     *  Gain: '<S298>/Gain6'
     */
    Robot_B.DataTypeConversion7 = static_cast<real_T>(Robot_B.Gain6) *
      1.8189894035458565E-12;
     ...
     *  Gain: '<S299>/Gain2'
     */
    Robot_B.DataTypeConversion4 = static_cast<real_T>(Robot_B.Gain2) *
      8.8817841970012523E-16;

    /* DataTypeConversion: '<S11>/Data Type Conversion8' */
    Robot_B.Motor1DCLinkCircuitVoltage = Robot_B.EtherCATPDOReceive4_d;

    /* Bias: '<S304>/Bias3' */
    Robot_B.Bias3 = Robot_B.EtherCATPDOReceive1_mt + Robot_cal->Bias3_Bias;

    /* Gain: '<S304>/Gain5' */
    Robot_B.Gain5 = static_cast<int64_T>(Robot_cal->Gain5_Gain) * Robot_B.Bias3;

    /* DataTypeConversion: '<S304>/Data Type Conversion9' incorporates:
     *  Gain: '<S304>/Gain5'
     */
    Robot_B.DataTypeConversion9 = static_cast<real_T>(Robot_B.Gain5) *
      1.8189894035458565E-12;
     ...
     *  Gain: '<S302>/Gain6'
     */
    Robot_B.DataTypeConversion7_k = static_cast<real_T>(Robot_B.Gain6_m) *
      1.8189894035458565E-12;
     ...
     *  Gain: '<S303>/Gain3'
     */
    Robot_B.DataTypeConversion5 = static_cast<real_T>(Robot_B.Gain3) *
      8.8817841970012523E-16;

    /* DataTypeConversion: '<S11>/Data Type Conversion11' */
    Robot_B.Motor2DCLinkCircuitVoltage = Robot_B.EtherCATPDOReceive4_g;
    ...
    Robot_B.DataTypeConversion12 = Robot_B.Bias;
    ...
    Robot_B.DataTypeConversion12_i = Robot_B.Bias_l;

    /* DataTypeConversion: '<S11>/Data Type Conversion14' */
    Robot_B.Sensor1IMUq0 = Robot_B.EtherCATPDOReceive3;

    /* DataTypeConversion: '<S11>/Data Type Conversion15' */
    Robot_B.Sensor1IMUq1 = Robot_B.EtherCATPDOReceive4_gz;

    /* DataTypeConversion: '<S11>/Data Type Conversion16' */
    Robot_B.Sensor1IMUq2 = Robot_B.EtherCATPDOReceive5;

    /* DataTypeConversion: '<S11>/Data Type Conversion17' */
    Robot_B.Sensor1IMUq3 = Robot_B.EtherCATPDOReceive6;

    /* DataTypeConversion: '<S11>/Data Type Conversion18' */
    Robot_B.Sensor2ADCh1 = Robot_B.EtherCATPDOReceive1_h;

    /* DataTypeConversion: '<S11>/Data Type Conversion19' */
    Robot_B.Sensor2ADCh2 = Robot_B.EtherCATPDOReceive2_p;

    /* DataTypeConversion: '<S11>/Data Type Conversion20' */
    Robot_B.Sensor2IMUq0 = Robot_B.EtherCATPDOReceive3_f;

    /* DataTypeConversion: '<S11>/Data Type Conversion21' */
    Robot_B.Sensor2IMUq1 = Robot_B.EtherCATPDOReceive4_n;

    /* DataTypeConversion: '<S11>/Data Type Conversion22' */
    Robot_B.Sensor2IMUq2 = Robot_B.EtherCATPDOReceive5_p;

    /* DataTypeConversion: '<S11>/Data Type Conversion23' */
    Robot_B.Sensor2IMUq3 = Robot_B.EtherCATPDOReceive6_c;
    ...
    Robot_B.DataTypeConversion12_c = Robot_B.Bias_e;
    ...
    Robot_B.DataTypeConversion12_cg = Robot_B.Bias_lu;

    /* DataTypeConversion: '<S11>/Data Type Conversion26' */
    Robot_B.Sensor3IMUq0 = Robot_B.EtherCATPDOReceive3_g;

    /* DataTypeConversion: '<S11>/Data Type Conversion27' */
    Robot_B.Sensor3IMUq1 = Robot_B.EtherCATPDOReceive4_h;

    /* DataTypeConversion: '<S11>/Data Type Conversion28' */
    Robot_B.Sensor3IMUq2 = Robot_B.EtherCATPDOReceive5_p4;

    /* DataTypeConversion: '<S11>/Data Type Conversion29' */
    Robot_B.Sensor3IMUq3 = Robot_B.EtherCATPDOReceive6_p;

    /* BusCreator: '<Root>/Bus Creator' */
    Robot_B.BusCreator.Motor1ActuralPosition = Robot_B.DataTypeConversion6;
    Robot_B.BusCreator.Motor1ActuralVelocity = Robot_B.DataTypeConversion7;
    Robot_B.BusCreator.Motor1ActuralTorque = Robot_B.DataTypeConversion4;
    Robot_B.BusCreator.Motor1DCLinkCircuitVoltage =
      Robot_B.Motor1DCLinkCircuitVoltage;
    Robot_B.BusCreator.Motor2ActuralPosition = Robot_B.DataTypeConversion9;
    Robot_B.BusCreator.Motor2ActuralVelocity = Robot_B.DataTypeConversion7_k;
    Robot_B.BusCreator.Motor2ActuralTorque = Robot_B.DataTypeConversion5;
    Robot_B.BusCreator.Motor2DCLinkCircuitVoltage =
      Robot_B.Motor2DCLinkCircuitVoltage;
    Robot_B.BusCreator.Sensor1ADCh1 = Robot_B.DataTypeConversion12;
    Robot_B.BusCreator.Sensor1ADCh2 = Robot_B.DataTypeConversion12_i;
    Robot_B.BusCreator.Sensor1IMUq0 = Robot_B.Sensor1IMUq0;
    Robot_B.BusCreator.Sensor1IMUq1 = Robot_B.Sensor1IMUq1;
    Robot_B.BusCreator.Sensor1IMUq2 = Robot_B.Sensor1IMUq2;
    Robot_B.BusCreator.Sensor1IMUq3 = Robot_B.Sensor1IMUq3;
    Robot_B.BusCreator.Sensor2ADCh1 = Robot_B.Sensor2ADCh1;
    Robot_B.BusCreator.Sensor2ADCh2 = Robot_B.Sensor2ADCh2;
    Robot_B.BusCreator.Sensor2IMUq0 = Robot_B.Sensor2IMUq0;
    Robot_B.BusCreator.Sensor2IMUq1 = Robot_B.Sensor2IMUq1;
    Robot_B.BusCreator.Sensor2IMUq2 = Robot_B.Sensor2IMUq2;
    Robot_B.BusCreator.Sensor2IMUq3 = Robot_B.Sensor2IMUq3;
    Robot_B.BusCreator.Sensor3ADCh1 = Robot_B.DataTypeConversion12_c;
    Robot_B.BusCreator.Sensor3ADCh2 = Robot_B.DataTypeConversion12_cg;
    Robot_B.BusCreator.Sensor3IMUq0 = Robot_B.Sensor3IMUq0;
    Robot_B.BusCreator.Sensor3IMUq1 = Robot_B.Sensor3IMUq1;
    Robot_B.BusCreator.Sensor3IMUq2 = Robot_B.Sensor3IMUq2;
    Robot_B.BusCreator.Sensor3IMUq3 = Robot_B.Sensor3IMUq3;

    /* Outport: '<Root>/BusOut' */
    Robot_Y.BusOut = Robot_B.BusCreator;

    /* Constant: '<S292>/Constant2' */
    Robot_B.Constant2_e = Robot_cal->State_5_Enable_TaskIndex;
...
void Robot_initialize(void)
{
  ...
  Robot_M->Timing.stepSize0 = 0.001;
  ...
  /* external inputs */
  Robot_U.BusIn = Robot_rtZControlBus;

  /* external outputs */
  Robot_Y.BusOut = Robot_rtZSensingBus;

  /* Start for Constant: '<S280>/Constant2' */
  Robot_B.Constant2 = Robot_cal->State_1_Enable_TaskIndex_njg;
  ...
  /* Start for Constant: '<S283>/Constant2' */
  Robot_B.Constant2_a = Robot_cal->State_2_Enable_TaskIndex_g;

  /* Start for Constant: '<S286>/Constant2' */
  Robot_B.Constant2_f = Robot_cal->State_3_Enable_TaskIndex_a;

  /* Start for Constant: '<S289>/Constant2' */
  Robot_B.Constant2_i = Robot_cal->State_4_Enable_TaskIndex;
