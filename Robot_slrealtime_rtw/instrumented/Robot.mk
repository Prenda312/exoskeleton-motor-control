###########################################################################
## Makefile generated for component 'Robot'. 
## 
## Makefile     : Robot.mk
## Generated on : Wed Jan 10 16:25:43 2024
## Final product: $(START_DIR)/Robot_slrealtime_rtw/Robot
...
START_DIR                 = C:/Users/My-Dell-PC/Desktop/ControllerDesign/Code/TestStructure06
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C++
...
PRODUCT = $(START_DIR)/Robot_slrealtime_rtw/Robot
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/Robot_slrealtime_rtw -I$(MATLAB_ROOT)/toolbox/slrealtime/simulink/blocks/dist/include -I$(MATLAB_ROOT)/toolbox/slrealtime/target/kernel/dist/include -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(START_DIR)/Robot_slrealtime_rtw/instrumented
...
DEFINES_STANDARD = -DMODEL=Robot -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/Robot_slrealtime_rtw/Robot.cpp $(START_DIR)/Robot_slrealtime_rtw/Robot_cal.cpp $(START_DIR)/Robot_slrealtime_rtw/rtGetInf.cpp $(START_DIR)/Robot_slrealtime_rtw/rtGetNaN.cpp $(START_DIR)/Robot_slrealtime_rtw/rt_nonfinite.cpp $(START_DIR)/Robot_slrealtime_rtw/slrealtime_datatype_ground.cpp $(START_DIR)/ecat_config_xml_0.cpp $(START_DIR)/Robot_slrealtime_rtw/rte_Robot_parameters.cpp $(START_DIR)/Robot_slrealtime_rtw/main.cpp $(MATLAB_ROOT)/toolbox/slrealtime/simulink/blocks/slrtEcatUtils.cpp host_timer_x86.c slrealtime_code_profiling_utility_functions.cpp
...
OBJS = Robot.o Robot_cal.o rtGetInf.o rtGetNaN.o rt_nonfinite.o slrealtime_datatype_ground.o ecat_config_xml_0.o rte_Robot_parameters.o main.o slrtEcatUtils.o host_timer_x86.o slrealtime_code_profiling_utility_functions.o
...
%.o : $(START_DIR)/Robot_slrealtime_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/Robot_slrealtime_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : $(START_DIR)/Robot_slrealtime_rtw/instrumented/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/Robot_slrealtime_rtw/instrumented/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


Robot.o : $(START_DIR)/Robot_slrealtime_rtw/Robot.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


Robot_cal.o : $(START_DIR)/Robot_slrealtime_rtw/Robot_cal.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetInf.o : $(START_DIR)/Robot_slrealtime_rtw/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetNaN.o : $(START_DIR)/Robot_slrealtime_rtw/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rt_nonfinite.o : $(START_DIR)/Robot_slrealtime_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


slrealtime_datatype_ground.o : $(START_DIR)/Robot_slrealtime_rtw/slrealtime_datatype_ground.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
rte_Robot_parameters.o : $(START_DIR)/Robot_slrealtime_rtw/rte_Robot_parameters.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


main.o : $(START_DIR)/Robot_slrealtime_rtw/main.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
